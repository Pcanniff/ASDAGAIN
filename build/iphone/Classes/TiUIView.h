...
/**
 Base class for all Canniff_Philip_Project4 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Canniff_Philip_Project4 view hierarchy (such as wrapped iOS UIViews) was touched.
