...
// in simulator we redefine to format for Canniff_Philip_Project4 Developer console
...
{\
	NSString * exceptionName = [@"org.canniff_philip_project4." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.canniff_philip_project4";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UICanniff_Philip_Project4NativeItemNone = -1, 
	UICanniff_Philip_Project4NativeItemSpinner = -2,
	UICanniff_Philip_Project4NativeItemProgressBar = -3,
	
	UICanniff_Philip_Project4NativeItemSlider = -4,
	UICanniff_Philip_Project4NativeItemSwitch = -5,
	UICanniff_Philip_Project4NativeItemMultiButton = -6,
	UICanniff_Philip_Project4NativeItemSegmented = -7,
	
	UICanniff_Philip_Project4NativeItemTextView = -8,
	UICanniff_Philip_Project4NativeItemTextField = -9,
	UICanniff_Philip_Project4NativeItemSearchBar = -10,
	
	UICanniff_Philip_Project4NativeItemPicker = -11,
	UICanniff_Philip_Project4NativeItemDatePicker = -12,
	
	UICanniff_Philip_Project4NativeItemInfoLight = -13,
	UICanniff_Philip_Project4NativeItemInfoDark = -14,
	
	UICanniff_Philip_Project4NativeItemDisclosure = -15,
	
	UICanniff_Philip_Project4NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Canniff_Philip_Project4 instances of
