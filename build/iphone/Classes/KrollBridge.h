...
@interface Canniff_Philip_Project4Object : KrollCoverageObject {
#else
@interface Canniff_Philip_Project4Object : KrollObject {
#endif
@private
...
extern NSString * Canniff_Philip_Project4$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Canniff_Philip_Project4Object *_canniff_philip_project4;
    KrollObject* console;
	BOOL shutdown;
