...
//@interface Canniff_Philip_Project4Object : NSObject
//@end

@interface Canniff_Philip_Project4Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Canniff_Philip_Project4Object class]])
		{
			for (NSString *key in [[(Canniff_Philip_Project4Object*)o modules] allKeys])
			{
