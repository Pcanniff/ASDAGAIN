...
//Rare exceptions to indicate a bug in the _canniff_philip_project4 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Canniff_Philip_Project4 proxies.
 */
